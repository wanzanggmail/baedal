...
final class RiderStatement
{
     ...
     * peak_time(원본) → 표기 버킷.
     *
     * 앞 5개는 **쿠팡**이 정산서에 주는 값이고, 뒤 4개는 **배민**이다 — 배민은 「피크타임」 열이
     * 없어 주문시각으로 유도한다(`XlsxParser::baeminPeak`, 2026-09-26 갑 시간표). 두 플랫폼의
     * 구간이 서로 다르므로(배민은 아침·점심이 한 구간) **합치지 않고 나란히 둔다** — 억지로
     * 대응시키면 라이더 명세서에 그 플랫폼에 없는 구간명이 찍힌다.
     */
