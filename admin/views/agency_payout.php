...
$wallet = $isAgency && !$needsMigrate ? AgencyWallet::withdrawable($myAgency) : null;
$rows   = !$needsMigrate ? AgencyPayout::listScoped($isAgency ? $myAgency : null) : [];
?>
<!--begin::Toolbar-->
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
	<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
		<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
			<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">대리점 자체 정산금 인출</h1>
			<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
				...
				<li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
				<li class="breadcrumb-item text-gray-900">대리점 자체 인출</li>
			</ul>
		</div>
	</div>
</div>
...
<?php require_once INC_PATH . '/app_content_open.php'; ?>
	...
	<div class="row g-6">
			...
			<div class="card card-flush mb-6">
				...
				<div class="card-body pt-2 fs-7">
					<div class="d-flex justify-content-between py-2 border-bottom border-gray-200">
						<span class="text-muted">대리점 잔액</span>
		...
		<div class="col-xl-<?= $isAgency ? '7' : '12' ?>">
			<div class="card card-flush">
	...
	(function () {
		...
		var isAgency = <?= $isAgency ? 'true' : 'false' ?>;
